...
CARROT_SETTINGS = {
  ...
  "ComfortBrake": {
    ...
    "help": "플래너가 <b>내가 편안하게 낼 수 있다고 가정하는 감속도</b>입니다. 추종 목표거리를 "
            "정하는 데 쓰입니다:<br><code>목표 = (내속도² − 앞차속도²)/(2×이값) + 추종시간×내속도 + 정지간격</code>"
            "<br><br><b>낮을수록 겁이 많아집니다</b> — 살살밖에 못 선다고 가정하니 더 많은 여유를 요구하고, "
            "같은 접근 속도에서 더 일찍·더 세게 밟습니다. 그리고 그만큼 벌려놓은 거리를 나중에 "
            "천천히 다시 좁힙니다."
            "<br><br>실주행 급제동 6건을 분해해보니 이 항이 목표거리의 <b>60%</b>였습니다"
            "(추종시간 항 34%, 정지간격 6%). 제동 요구량 합계 기준으로 "
            "2.8은 −16%, <b>3.2는 −28%</b>, 3.6은 −38%입니다."
            "<br><br>앞차가 훨씬 느린 진짜 위급 상황(70mph에서 앞차 25mph, 35m)에서는 이 값을 올려도 "
            "여전히 세게 밟습니다 — 그게 맞고, 줄어드는 건 일상적인 과반응 쪽입니다.",
    "options": [(240, "2.4 (기존)"), (280, "2.8"), (320, "3.2"), (360, "3.6 공격적")],
  },
  "StopDistanceCarrot": {
