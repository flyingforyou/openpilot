...
MAP_SETTINGS = {
  ...
  "TeslaMapAutoSpeedUseCarOffset": {
    ...
    "help": "테슬라 메뉴의 '제한속도 +n' 값(UI_userSpeedOffset)을 <b>상한으로</b> 씁니다."
            "<br><br>더하는 양은 제한속도에 따라 정해집니다 — <b>40mph 미만 +5, 40mph 이상 "
            "+10</b>. 25mph 구역에 +10을 더하면 제한의 40%를 얹는 셈이고, 플릿은 그렇게 안 "
            "달립니다: 전체 로그에서 25mph 구역 플릿은 <b>+4.1</b>(35.9만 샘플), 35mph는 "
            "<b>+4.7</b>(66.9만), 65mph는 <b>+7.7</b>(164.7만)이었습니다."
            "<br><br>이 옵션을 켜면 그 사다리와 차량 설정값 중 <b>낮은 쪽</b>을 씁니다. 차에서 "
            "+3으로 해두셨으면 40mph 이상에서도 +3만 더합니다. 끄면 사다리만 씁니다."
            "<br><br>같은 사다리가 상한(OVER_LIMIT_CAP 대체)에도 쓰입니다 — 목표가 제한+5인 "
            "구간을 제한+10으로 막아봐야 상한 구실을 못 하기 때문입니다.",
    "options": [(0, "사다리만 사용"), (1, "차량 설정을 상한으로 (기본)")],
  },
