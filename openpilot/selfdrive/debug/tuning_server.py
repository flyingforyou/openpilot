...
CARROT_SETTINGS = {
  ...
  "TeslaBrakeJerk": {
    ...
    "help": "차에 <b>브레이크를 얼마나 빨리 물려도 되는지</b>(DAS_jerkMin)를 알려주는 값의 하한입니다. "
            ...
            "<br><br><b>⚠ 이번 변경 중 안전에 가장 민감합니다.</b> 낮출수록 부드럽지만 목표 감속도에 "
            "도달하는 시간이 늘어납니다. 2.0 부터 시작해 보세요.",
    "options": [(0, "사용 안 함 (기본)"), (15, "1.5 강하게 조임"), (20, "2.0 (권장 시작점)"),
                (30, "3.0 약하게"), (40, "4.0 거의 지금과 같음")],
  },
  "RadarLeadHoldCm": {
