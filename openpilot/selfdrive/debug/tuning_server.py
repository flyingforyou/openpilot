...
CARROT_SETTINGS = {
  ...
  "TFollowDecelBoost": {
    ...
    "help": "내가 감속 중일 때 목표 간격을 추가로 벌립니다. 앞차 급감속·정지차 접근에 더 일찍 반응하게 "
            "합니다. 크면 과거의 급제동이 재발할 수 있어 작게 시작합니다.",
    "options": [(0, "없음"), (30, "약하게 0.3 (기본)"), (50, "표준 0.5"), (100, "크게 1.0")],
  },
  "ComfortBrake": {
    ...
    "help": "플래너가 <b>내가 편안하게 낼 수 있다고 가정하는 감속도</b>입니다. 목표거리 곡선의 "
            ...
            "45mph 기준 목표거리를 약 13m 줄입니다 — 갭 표(거리)는 순정 차간거리에 맞춰 올려둔 상태라"
            "(2026-08-31, gap4 ≈ 2.3초), 이 값은 곡선의 곡률만 건드린다고 보면 됩니다."
