...
class MyMovingAverage:
  """Sliding-window mean, with an option to take the median instead.

  From CarrotPilot, where the longitudinal planner uses it to steady the stop-line distance and
  the model's speed estimate. A first-order filter would lag a step change; a window forgets the
  old value outright once it falls off the end, which is what those two want.
  """
