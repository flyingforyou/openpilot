...
inline static std::unordered_map<std::string, ParamKeyAttributes> keys = {
    ...
    {"CurveSpeedLatAccelCms", {PERSISTENT, INT, "220"}},
    ...
    {"DynamicTFollowGain", {PERSISTENT, INT, "0"}},
    ...
    {"LaunchAccelCms", {PERSISTENT, INT, "160"}},
    {"LeadCreepFollowCms", {PERSISTENT, INT, "0"}},
    ...
    {"GreyLeadAccelCapCms", {PERSISTENT, INT, "0"}},
    {"GreyLeadProbPct", {PERSISTENT, INT, "0"}},
    ...
    {"TeslaVelocityPid", {PERSISTENT, BOOL, "0"}},
